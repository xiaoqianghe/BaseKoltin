package com.xiaoqianghe.koltin.basekoltin.glide;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.xiaoqianghe.koltin.basekoltin.glide.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.xiaoqianghe.koltin.basekoltin.glide.GlideOptions().apply(toSet));
    }
  }
}
